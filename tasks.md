...
## 진행 중
- [x] **BlogDoc 프로젝트 Phase 1 완료 + Vercel 배포** — Sanghun 지시 (2026-04-25). 네이버 쇼핑커넥터/쿠팡 파트너스 어필리에이트 블로그 자동 생성. Next.js 프로젝트 세팅, 3단계 UI, /api/suggest(상품추천), /api/blog/generate(블로그생성) API 구현. 빌드 성공. Vercel 배포 완료: blogdoc-tau.vercel.app.
