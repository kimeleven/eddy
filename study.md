...
- **토큰 변경은 Sanghun 승인 없이 절대 금지** — 토큰 만료/오류가 발생해도 임의로 교체하지 말 것. 반드시 Sanghun에게 보고 후 승인 받아서 처리. (2026-04-13 직접 지시)
...
## AI-Secretary 프로젝트 방향 (2026-04-11 Sanghun 지시)
- **글로벌 서비스 지향**: 다양한 언어 지원 (i18n), 글로벌 유저 기준 설계
- **Stripe 결제 확정**: 글로벌 표준. USD 기준으로 전환 예정.
- **현재 범위**: 채팅(Phase 1~3) + 음성통화(Phase 4)까지. Phase 5(비디오통화)는 **보류** (Sanghun 지시 2026-04-11 18:XX: "음성통화 이전까지만 해. 음성통화부터는 나중에하자")
- Phase 4 음성통화는 이미 완료됨 → Phase 5 착수 중단
