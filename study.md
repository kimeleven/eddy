...
## ELDO 프로젝트
- 신규 프로젝트 (2026-04-03 지시)
- GitLab 연동 예정 — Sanghun이 기초 코드 제공 예정 (코드는 엉성한 상태)
- 목표: 현재 상황 파악 + 개선 방향 도출
- **팀 구성**: 기획자 1명 + 개발자 1명 (서브에이전트)
  - 기획자: 앞으로 할 것 정리 (내용은 Sanghun이 직접 제공)
  - 개발자: 현재 코드 리뷰 → 정리 → 기획자와 논의하며 개선
